...
use crate::features::project::CreateProjectButton;

#[component]
pub fn ProjectsSidebar(
    names: Vec<String>,
    error: Option<String>,
    ...
    rsx! {
        div { class: "space-y-3",
            div { class: "flex items-center justify-between",
                h1 { class: "text-xl font-bold", "Projects" }
                CreateProjectButton {}
            }
...
#[component]
fn SidebarLink(project_name: String, is_active: bool) -> Element {
    ...
    let route = format!("/projects/{project_name}");
