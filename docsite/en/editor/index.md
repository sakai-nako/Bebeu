...
A Dioxus-desktop editor (`packages/editor-desktop`). It reads and writes the YAML files under the workspace's `data/` directory to author Projects, Characters, and Levels.

This section walks through the editor end to end, from launching it to editing a Project.

## Sections

- [Setup and launch](./setup.md) — first-time setup and starting the dev server
